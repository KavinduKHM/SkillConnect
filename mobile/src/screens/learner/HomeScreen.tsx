...
const styles = StyleSheet.create({
  ...
  greetingSub: { fontSize: 14, color: '#64748B', fontWeight: '400' },
  greetingName: { fontSize: 24, fontWeight: '800', color: '#0F172A', letterSpacing: -0.4 },
  ...
  avatarHeader: { width: 40, height: 40, borderRadius: 20, borderWidth: 1, borderColor: '#E2E8F0' },
  searchBox: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#FFFFFF',
  ...
  categoryPillActive: { backgroundColor: '#164E37', borderColor: '#164E37' },
  categoryText: { fontSize: 14, fontWeight: '600', color: '#334155' },
  categoryTextActive: { color: '#FFFFFF' },
  sectionHeading: { fontSize: 20, fontWeight: '800', color: '#0F172A', marginBottom: 14, letterSpacing: -0.3 },
  continueCard: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#FFFFFF',
  ...
  continueThumbnail: { width: 68, height: 68, borderRadius: 14 },
  continueTitle: { fontSize: 15, fontWeight: '700', color: '#0F172A', marginBottom: 4 },
  creatorRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 },
  creatorName: { fontSize: 12, color: '#64748B', fontWeight: '500' },
  ...
  progressMeta: { fontSize: 11, color: '#94A3B8', fontWeight: '600' },
  playCircleBtn: {
    width: 44,
    height: 44,
    borderRadius: 22,
  ...
  playIconText: { fontSize: 16, color: '#166534', marginLeft: 2 },
  recCard: {
    width: 210,
    backgroundColor: '#FFFFFF',
    borderRadius: 18,
  ...
  recThumbnail: { width: '100%', height: 115 },
  ...
  seeAllText: { fontSize: 14, fontWeight: '700', color: '#164E37' },
});
